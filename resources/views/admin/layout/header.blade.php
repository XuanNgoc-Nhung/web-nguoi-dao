<div class="header">
    ...
    <div class="header-left">
        <a href="{{route('user.getHome')}}" class="logo">
            <img src="https://bizweb.dktcdn.net/100/257/549/themes/918015/assets/logo.png?1717404002200" style="width: 140px" alt="Logo">
        </a>
        <a href="{{route('user.getHome')}}" class="logo logo-small">
